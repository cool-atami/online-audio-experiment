...
以上で最低限の実験が作成できました。ただ、このミニマルな実験にはいろいろな問題があります。例えば、トライアルが増えたらその分のコードを増やさないといけません。また、実験によっては回答があっているか間違っているかのフィードバックもしたいのですが、そのような仕組みも入っていません。そうした細かい問題は [04_jspsych_intermediate](../04_jspsych_intermediate)で解決するとして、次の [03_jspsych_basic](../03_jspsych_basic) では上のミニマル実験に使われた4要素を解説しようと思います。
